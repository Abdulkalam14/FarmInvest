...
const Farmercard = () => {
  return (
    ...
    <a href="/farmers/:id" class="w-full h-[300px] mx-auto flex flex-col border mb-4 border-gray-500 rounded-xl md:flex-row hover:bg-gray-200 dark:bg-gray-800 dark:hover:bg-gray-700">
