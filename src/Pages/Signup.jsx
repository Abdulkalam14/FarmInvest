...
const Signup = () => {
    ...
    const handleSubmit = async(e) =>{
        e.preventDefault();
        try{
          const {data} = await axios.post("http://localhost:3000/user/signupInvestor", {
            ...values,
          }
          );
          if (data) {
      ...
      <div class="w-full bg-white rounded-lg shadow dark:border md:mt-0 sm:max-w-md xl:p-0 dark:bg-gray-800 dark:border-gray-700">
          <div class="p-6 space-y-4 md:space-y-6 sm:p-8">
              ...
              <form onSubmit={(e)=>handleSubmit(e)} class="space-y-4 md:space-y-6" action="#">
                  ...
                  <p class="text-sm font-light text-gray-500 dark:text-gray-400">
                      Are you a farmer? <a href="/signin" class="font-medium text-primary-600 hover:underline dark:text-primary-500">Apply as a Farmer</a>
                  </p>
              </form>
